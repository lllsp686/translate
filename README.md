...
- 📥 **双语精读笔记与 PDF/HTML 一键导出**：
  - 顶部工具栏支持一键导出标准 Markdown 双语排版笔记，以及独立高保真 HTML 网页，支持一键 `Command + P` 打印为双语对照 PDF。
- 🔍 **鼠标划词/长难句即时悬浮翻译**：
  - 鼠标划选任意英文单词或难句，瞬间弹出毛玻璃气泡即时释义，支持一键收录至专属生词本/专业术语库。
- 🖍️ **四色荧光笔划线与科研阅读批注**：
  - 支持划线标黄、标绿、标蓝、标粉，段落旁可随手记录个人科研思考与批注，数据随文档永久持久化保存。
- 🤖 **AI 论文伴读助手（Paper Copilot）**：
  - 一键秒级提取四维学术速读简报（🎯核心突破、🔬技术路线、📊实验指标、⚠️潜在局限）；
  - 全文深度对话问答，随时针对论文中的公式参数、对比模型与研究结论向 AI 自由提问。
- 🔄 **双栏双向平滑滚动联动**：
